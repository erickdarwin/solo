...
public class ListAsis extends Fragment {
    ...
    private RecyclerView.Adapter<AsistenciaViewHolder> adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View viewMyFragment =inflater.inflate(R.layout.fragment_list_asis, container, false);

        this.recyclerView=(RecyclerView)viewMyFragment.findViewById(R.id.recyclerviewAsis);
